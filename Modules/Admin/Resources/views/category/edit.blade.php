...
@section('content')
    <h4 class="page-title mb-1">Sửa danh mục</h4>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-square" id="squareInput" name="c_name" value="{{ $category[0]->c_name }}">
                            @error('c_name')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="comment" rows="4" name="c_desc">{{ $category[0]->c_desc }}</textarea>
                            @error('c_desc')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>                              
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <img src="{{ url( $category[0]->c_avatar) }}" id="output" style="max-width: 125px; border: 1px solid gray; padding: 1px">
                        </div>
                        <input type="hidden" value="{{ $category[0]->c_avatar }}" name="c_old_avatar">  
