...
@section('content')
    <h4 class="page-title mb-1">Thêm sản phẩm</h4>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-square" id="squareInput" name="pro_name">
                            @error('pro_name')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="comment" rows="2" name="pro_desc"></textarea>
                            @error('pro_desc')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control input-square" id="squareInput" name="pro_number">
                                </div>
                            </div>
                        </div>  
                        <div class="form-group">
                            <label for="comment">Nội dung:</label>
                            <textarea class="form-control" id="pro_content" rows="4" name="pro_content"></textarea>
                            @error('pro_content')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label for="squareInput">Số lượng:</label>
                            <input type="file" multiple class="form-control input-square" id="album_image" name="album_image">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control input-square" id="squareInput" name="pro_price" min="0">
                            @error('pro_price')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control input-square" id="squareInput" name="pro_sale" min="0" max="100">
                            @error('pro_sale')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
